---
section_id: I.S.10
section_name: Synthetic Firm Sourcing
pillar: inflows
category: I.S
category_name: 'Inflows: Secured'
definition_summary: 'Refers to total return swaps that are not booked in client accounts,
  where the reporting entity

  is economically short the underlying reference asset and the counterparty is economically
  long.'
data_fields:
- name: product
  type: string

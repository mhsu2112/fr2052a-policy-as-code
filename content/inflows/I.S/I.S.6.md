---
section_id: I.S.6
section_name: Other Secured Loans - Rehypothecatable
pillar: inflows
category: I.S
...
definition_summary: 'Refers to all other secured lending that does not otherwise meet
  ...
  Secured products listed above and is not drawn from a revolving facility, for which
  the collateral

  received is contractually rehypothecatable.'
data_fields:
- name: product
  type: string

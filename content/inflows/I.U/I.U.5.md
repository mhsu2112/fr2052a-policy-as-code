---
section_id: I.U.5
section_name: Outstanding Draws on Unsecured Revolving Facilities
pillar: inflows
category: I.U
category_name: 'Inflows: Unsecured'
definition_summary: Refers to the existing loan arising from the drawn portion of
  any unsecured revolving facility
data_fields:
- name: product
  type: string

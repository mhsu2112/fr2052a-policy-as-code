---
section_id: O.O.13
section_name: Total Collateral Required Due to a 1 Notch Downgrade
pillar: outflows
category: O.O
...
definition_summary: 'Refers to the total cumulative fair value of additional collateral
  ...
  counterparties will require the reporting entity to post as a result of a 1- notch
  credit rating
...
cross_references:
- section: O.O.9
  relationship: o not double count balances reported in O.O.9.
version_history:
- version: '2025-02-26'

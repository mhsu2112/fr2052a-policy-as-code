---
section_id: O.O.9
section_name: Loss of Rehypothecation Rights Due to a 1 Notch Downgrade
pillar: outflows
category: O.O
category_name: 'Outflows: Other'
definition_summary: Refers to the total fair value of the collateral over which the
  reporting entity would lose
data_fields:
- name: product
  type: string

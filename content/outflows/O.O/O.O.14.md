---
section_id: O.O.14
section_name: Total Collateral Required Due to a 2 Notch Downgrade
pillar: outflows
category: O.O
...
definition_summary: 'Refers to the total cumulative fair value of additional collateral
  ...
  counterparties will require the reporting entity to post as a result of a 2- notch
  credit rating
...
cross_references:
- section: O.O.10
  relationship: o not double count balances reported in O.O.10.
version_history:
- version: '2025-02-26'

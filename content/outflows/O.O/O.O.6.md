---
section_id: O.O.6
section_name: Retail Mortgage Commitments
pillar: outflows
category: O.O
category_name: 'Outflows: Other'
definition_summary: Refers to contractual commitments made by the reporting entity
  to originate retail mortgages.
data_fields:
- name: product
  type: string

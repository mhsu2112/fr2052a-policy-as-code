---
section_id: O.W.13
section_name: Government Supported Debt
pillar: outflows
category: O.W
category_name: 'Outflows: Wholesale'
definition_summary: Refers to debt issuances with an explicit guarantee from a sovereign
  entity or central bank (e.g.,
data_fields:
- name: product
  type: string

---
section_id: O.D.6
section_name: Non-Operational Account Balances
pillar: outflows
category: O.D
category_name: 'Outflows: Deposits'
definition_summary: Refers to all deposits balances from counterparties that are not
...
cross_references:
- section: O.D.5
  relationship: in operational accounts, reported under O.D.5).
version_history:
- version: '2025-02-26'

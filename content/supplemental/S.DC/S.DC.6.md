---
section_id: S.DC.6
section_name: Initial Margin Posted - Customer
pillar: supplemental
category: S.DC
...
definition_summary: 'Refers to the fair value of collateral that the reporting entity
  ...
  applicable [Collateral Class]) to its counterparties as initial margin on behalf
  of customers.'
data_fields:
- name: product
  type: string
...
reporting_notes: Include initial margin related to customer transactions to which
  the reporting entity is acting as either principal or agent. Use the [Sub-Product
  2] field to distinguish initial margin posted where the reporting entity is acting
  as agent and does not guarantee the performance of the counterparty to its customer
  from all other initial margin posted on behalf of customers.
---

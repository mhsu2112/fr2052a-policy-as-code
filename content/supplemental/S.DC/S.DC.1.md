---
section_id: S.DC.1
section_name: Gross Derivative Asset Values
pillar: supplemental
category: S.DC
category_name: 'Supplemental: Derivatives & Collateral'
definition_summary: 'Refers to the aggregate value of derivative transactions not
  subject to qualifying master netting

  agreements that are assets and the net value of derivative transactions within qualifying
  master

  netting agreements where the netting sets are assets.'
data_fields:
- name: product
  type: string

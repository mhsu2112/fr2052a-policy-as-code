---
section_id: S.DC.15
section_name: Sleeper Collateral Deliverables
pillar: supplemental
category: S.DC
category_name: 'Supplemental: Derivatives & Collateral'
definition_summary: Refers to the fair value of unsegregated collateral that the reporting
  entity may be required by
data_fields:
- name: product
  type: string

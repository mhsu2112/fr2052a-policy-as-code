---
section_id: S.DC.8
section_name: Variation Margin Posted - House
pillar: supplemental
category: S.DC
...
definition_summary: 'Refers to the fair value of collateral that the reporting entity
  ...
  applicable [Collateral Class]) to its counterparties as variation margin on its
  own proprietary
...
cross_references:
- section: S.DC.3
  relationship: payments, which must be reported under S.DC.3.
version_history:
- version: '2025-02-26'
  change: Current version
reporting_notes: Exclude variation margin delivered on outstanding contracts in the
  form of settlement payments, which must be reported under S.DC.3.
---

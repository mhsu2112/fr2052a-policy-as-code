---
section_id: S.DC.13
section_name: Collateral Disputes Deliverables
pillar: supplemental
category: S.DC
category_name: 'Supplemental: Derivatives & Collateral'
definition_summary: 'Refers to the fair value of collateral called by the reporting
  entity’s counterparties that the

  reporting entity has yet to deliver due to a dispute.'
data_fields:
- name: product
  type: string
...
cross_references:
- section: S.DC.14
  relationship: previous year for products S.DC.13 and S.DC.14 is less than $500 million,
    the reportin
version_history:
- version: '2025-02-26'
...
distinct disputes over the previous year for products S.DC.13 and S.DC.14 is less than $500

---
section_id: S.I.3
section_name: Gross Client Wires Received
pillar: supplemental
category: S.I
category_name: 'Supplemental: Informational'
definition_summary: 'Refers to all wires received into Prime Brokerage client accounts
  occurring on day T. This

  product must only be reported when a firm has a broker-dealer that is a material
  entity (i.e., is
